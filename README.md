...
* CRUD: create, update and remove movies with Firebase
...
This repo is using Firebase. We use Cloud Firestore and Cloud Storage to handle CRUD operations over the movies and to store their images. Also Hosting and Functions to deploy the app with Universal.

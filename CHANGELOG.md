...
* **movie card:** add movie card component ([0d32deb](https://github.com/Ismaestro/angular7-example-app/commit/0d32deb))
* **movie loading:** add as a component ([72bdd21](https://github.com/Ismaestro/angular7-example-app/commit/72bdd21))
...
* **loading card:** add movie loading state ([8454020](https://github.com/Ismaestro/angular7-example-app/commit/8454020))
...
* **movie detail:** solve problem with activated route mock ([17ea07e](https://github.com/Ismaestro/angular7-example-app/commit/17ea07e))
* **movie service:** solve an async problem with the creation of the test movie ([02a37d8](https://github.com/Ismaestro/angular7-example-app/commit/02a37d8))
* **movie service:** solve an async problem with the creation of the test movie ([047bba9](https://github.com/Ismaestro/angular7-example-app/commit/047bba9))
* **movie service:** solve problem with created test movies become useless ([ca11544](https://github.com/Ismaestro/angular7-example-app/commit/ca11544))
...
* **movie detail:** added movie json ([29932b2](https://github.com/Ismaestro/angular7-example-app/commit/29932b2))
* **movie list:** replace all [ngClass] appearances to [class.name] way ([fc2f15f](https://github.com/Ismaestro/angular7-example-app/commit/fc2f15f))
* **movie top:** added movie detail links ([b565f1d](https://github.com/Ismaestro/angular7-example-app/commit/b565f1d))
...
* **params:** update extraction of the id param for movie detail ([0deda48](https://github.com/Ismaestro/angular7-example-app/commit/0deda48))
...
* **coinhive:** added this miner to pay movieku dynos ([eb9c125](https://github.com/Ismaestro/angular5-example-app/commit/eb9c125))
...
* **e2e:** updated number of default movies ([cd0b1d4](https://github.com/Ismaestro/angular5-example-app/commit/cd0b1d4))
...
* **e2e:** updated number of default movies ([cd0b1d4](https://github.com/Ismaestro/angular4-example-app/commit/cd0b1d4))
